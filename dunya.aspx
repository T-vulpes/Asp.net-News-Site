<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/dunya.aspx.cs" Inherits="dunya" %>
        ...
        <div id="popup" class="popup">
            <div class="popup-content">
                ...
                <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [haberler] WHERE kategori='Dünya'"></asp:AccessDataSource>
            </div>
        </div>
        <div id="icerik">

    <h1>DÜNYA'DAN HABERLER</h1>
            &nbsp;
