...
using System.Data;
public partial class ekonomi : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string query = "SELECT haber_baslik, haber_icerik, haber_resmi, haber_linki FROM haberler WHERE kategori='Ekonomi'";
